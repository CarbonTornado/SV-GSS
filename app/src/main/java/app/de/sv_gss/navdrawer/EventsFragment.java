...
public class EventsFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getJSON("https://sv-gss.de/app/termine.php?token=1303");
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            name.add(userDetail.getString("datum"));
    ...
    private void writeToFile(String data, Context context) {
        try {
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(context.openFileOutput("jsonEvents.txt", Context.MODE_PRIVATE));
    ...
    private String readFromFile(Context context) {
        ...
        try {
            InputStream inputStream = context.openFileInput("jsonEvents.txt");
