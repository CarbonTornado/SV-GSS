 ...
 * {@link ProtocolsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ProtocolsFragment#newInstance} factory method to
...
public class ProtocolsFragment extends Fragment {
    ...
    public static ProtocolsFragment newInstance(String param1, String param2) {
        ProtocolsFragment fragment = new ProtocolsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_protocols, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getJSON("https://sv-gss.de/app/protokolle.php?token=1303");
    ...
    private void writeToFile(String data, Context context) {
        try {
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(context.openFileOutput("jsonProtocols.txt", Context.MODE_PRIVATE));
    ...
    private String readFromFile(Context context) {
        ...
        try {
            InputStream inputStream = context.openFileInput("jsonProtocols.txt");
