...
public class MembersFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getJSON("https://sv-gss.de/app/mitglieder.php?token=1303");
    ...
    private void loadIntoListView(String json) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            name.add(userDetail.getString("vorname"));
            beschreibung.add(userDetail.getString("amt"));
            // fetch mobile number and store it in arraylist
            leiter.add(userDetail.getString("jahrgang"));
            termine.add(userDetail.getString("email"));
    ...
    private void writeToFile(String data, Context context) {
        try {
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(context.openFileOutput("jsonMembers.txt", Context.MODE_PRIVATE));
    ...
    private String readFromFile(Context context) {
        ...
        try {
            InputStream inputStream = context.openFileInput("jsonMembers.txt");
